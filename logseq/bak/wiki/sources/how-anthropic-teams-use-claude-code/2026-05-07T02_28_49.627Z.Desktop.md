...
raw-file:: _raw/how-anthropic-teams-use-claude-code.md
created:: [[2026-05-06]]
---
...
3. **文档维护** — [[claude-md-files]] 作为持续改进飞轮
4. **独立调试** — 敢于在陌生代码库中独立工作

### 通用技巧
- 写详细的 [[claude-md-files]]（workflows、tools、expectations 都要记录）
- 使用 [[checkpoint-workflow]]（频繁提交，失败时回滚）
- 外围任务用 auto-accept，核心功能需监督
- 在 Claude.ai 规划，在 Claude Code 实现
- 从最少信息开始，迭代而非一次性解决

## 与其他资料的关系
- 与 [[10-lessons-for-agentic-coding]] 互补：Breunig 是理论原则，本文是 Anthropic 内部的实战案例
- 与 [[harness]] 的关联：本文的 Claude.md 文件和 checkpoint 实践正是 Harness 思想的具体落地
- 与 [[agentic-coding]] 直接相关：大量具体案例验证了"经验放大"、"代码廉价但要谨慎"等原则
- 补充 [[living-specs]]：end-of-session documentation updates 是 living specs 在实践中的具体形式
