...
created:: [[2026-05-07]]
sources:: [[hermes-agent-memory-system]]
related:: [[harness]], [[skills]], [[progressive-disclosure]], [[agent-efficiency]], [[knowledge-lifecycle]]
---
...
实现方式：提示词中只放**技能索引**（轻量），完整技能内容按需加载——与 [[progressive-disclosure]] 和 [[tool-search]] 的设计理念一致。
...
- [[skills]] — Hermes Skills 层的程序记忆实现
- [[progressive-disclosure]] — 技能索引 + 按需加载 = 渐进式发现模式
- [[agent-efficiency]] — Prompt Cache 命中率是 Agent 效率的核心指标之一
- [[knowledge-lifecycle]] — 知识成熟度管理与记忆冲刷/衰减机制的相似性
- [[harness]] — 记忆系统是 Context Engineering（上下文工程）支柱的核心组成

## 来源

- [[hermes-agent-memory-system]] — Manthan Gupta 对 Hermes 开源代码的深度拆解
