...
| **提炼** | 读完留下什么？ | [[llm-wiki-pattern]]、笔记系统、知识编译 |
...
## 关联
- [[llm-wiki-pattern]] — 个人知识编译，解决"读完留下什么"
- [[information-workflow]] — 信息过滤是工作流的核心环节
- [[agentic-coding]] — Agent 也面临"工具判断"问题，与信息判断同构

## 来源
- [[bestblogs-2.0-reading-workflow]] — BestBlogs 2.0 的核心产品洞察
- [[llm-wiki-pattern]] — Karpathy 从个人角度解决同类问题
