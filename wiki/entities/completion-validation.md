...
created:: [[2026-05-07]]
updated:: [[2026-05-07]]
sources:: [[prevent-premature-completion]], [[e2e-testing-changes-results]]
related:: [[harness]], [[harness-5-subsystems]], [[wip-limit]], [[feature-list-primitive]], [[harness-observability]]
---
...
- [[prevent-premature-completion]] — 过早完成声明 + 置信度校准偏差 + 三层终止校验
- [[e2e-testing-changes-results]] — 单元测试盲区 + E2E 改变行为 + 架构边界执行
