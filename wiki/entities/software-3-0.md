...
related:: [[agentic-coding]], [[vibe-coding]], [[harness]], [[llm-wiki-pattern]]
---
...
- [[agentic-coding]] — Software 3.0 时代开发者的新角色（判断者/引导者/架构师）
- [[vibe-coding]] — Software 3.0 的极端形式：让模型完全主导代码生成
- [[harness]] — 在 Software 3.0 下如何安全地约束和引导 Agent
- [[llm-wiki-pattern]] — Karpathy 提到的 LLM Knowledge Bases 是 Software 3.0 应用的典型例子

## 来源

- [[karpathy-vibe-coding-to-agentic-engineering]] — Karpathy 在 Sequoia AI Ascent 2026 的访谈
