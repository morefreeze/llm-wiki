...
created:: [[2026-05-07]]
updated:: [[2026-05-07]]
sources:: [[session-continuity-across-sessions]], [[initialization-independent-phase]]
related:: [[harness]], [[harness-5-subsystems]], [[repo-as-system-of-record]], [[clean-session-state]], [[feature-list-primitive]]
---
...
- [[session-continuity-across-sessions]] — 四种连续性工件 + 上下文焦虑 + 漂移 + 实战数据
- [[initialization-independent-phase]] — 自举契约 + 独立初始化阶段
