...
raw:: [[source/session-continuity-across-sessions]]
---
...
- [[entity/session-continuity]] — 跨会话连续性核心概念
- [[entity/harness-5-subsystems]] — 状态子系统（PROGRESS.md）是五子系统之一
- [[entity/repo-as-system-of-record]] — 仓库作为事实来源是连续性的基础
