...
- ## 概述
  与 AI Agent 协作时，**频繁提交 Git checkpoint**，Agent 实验失败时直接回滚，而不是试图修复错误。是 [[entity/agentic-coding]] 中管理 Agent 自主工作风险的核心实践。
- ## 核心思路
...
- ## 关联
- [[entity/agentic-coding]] — Checkpoint 工作流是 agentic coding 的安全网
- [[entity/claude-md-files]] — Claude.md 中写入 checkpoint 指令（"commit as you go"）
- [[entity/living-specs]] — 每次 session 结束时更新规格，形成闭环
- ## 来源
- [[source/how-anthropic-teams-use-claude-code]] — RL Engineering、Data Science、Security Engineering 三个团队的共同实践
- [[source/10-lessons-for-agentic-coding]] — "Rebuild Often" 原则的底层支撑