...
created:: [[2026-05-07]]
updated:: [[2026-05-07]]
sources:: [[source/instruction-file-architecture]]
related:: [[entity/harness]], [[entity/harness-5-subsystems]], [[entity/repo-as-system-of-record]], [[entity/session-continuity]]
---
...
- 安全约束遵循率：**60% → 95%**
- ## 参考来源
- [[source/instruction-file-architecture]] — 路由文件架构详细讲解 + 中间迷失效应实践含义