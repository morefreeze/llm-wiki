...
created:: [[2026-05-06]]
sources:: [[source/harness-knowledge-moat]]
related:: [[entity/harness]], [[entity/progressive-disclosure]], [[source/llm-wiki-pattern]], [[entity/living-specs]]
---
...
- ## 自动衰减机制
  ...
  > 设计借鉴 Karpathy [[source/llm-wiki-pattern]] 的 Lint 操作。
- ## 团队知识库实现
- ### 独立 Git 仓库
...
- ## Lint 机制
  ...
  | 重复/相似条目 | 标记合并候选 |
- ## 关联
- [[entity/harness]] — 知识管理是 Harness Engineering 的核心组成
- [[entity/progressive-disclosure]] — 三级索引与渐进式发现的同构关系
- [[source/llm-wiki-pattern]] — Karpathy LLM Wiki 的 ingest/query/lint 三操作是本框架的思想来源
- [[entity/living-specs]] — decision/guideline 知识类型与活规格文档的关联
- ## 来源
- [[source/harness-knowledge-moat]] — stevenpxiao 的 AI Team 知识架构实践