...
raw:: [[source/initialization-independent-phase]]
---
...
- [[entity/session-continuity]] — 跨会话连续性（初始化是跨会话可靠性的前提）
- [[entity/harness-5-subsystems]] — 指令+状态子系统在初始化阶段建立
- [[entity/repo-as-system-of-record]] — 自举契约文档是仓库即规范的组成部分
