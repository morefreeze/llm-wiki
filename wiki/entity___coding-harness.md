...
created:: [[2026-05-07]]
sources:: [[source/coding-agent-components]]
related:: [[entity/harness]], [[entity/agent-memory-system]], [[entity/progressive-disclosure]], [[entity/skills]], [[entity/vibe-coding]], [[entity/agentic-coding]]
---
...
- ### 2. 提示词形态与缓存复用 (Prompt Shape & Cache Reuse)
  ...
  → 与 [[entity/agent-memory-system]] 的 Prompt Cache 设计原则高度一致（热/冷分离，缓存友好）
- ### 3. 工具的接入与调用 (Tool Access & Use)
  ...
  → 与 [[entity/progressive-disclosure]] 的按需发现工具思路互补
...
- ### 5. 结构化会话记忆 (Structured Session Memory)
  ...
  → 与 [[entity/agent-memory-system]] 的双层记忆架构（提示词记忆 + SQLite 冷存储）形成对照
...
- ## 参见
- [[entity/harness]] — Harness 的上位概念（安全带 + 方向盘）
- [[entity/agent-memory-system]] — Hermes 四层记忆架构对照
- [[entity/progressive-disclosure]] — 工具按需加载
- [[entity/agentic-coding]] — 使用 Agent 辅助编码的范式
- [[entity/vibe-coding]] — Vibe Coding vs Agentic Engineering 的上限/下限区分