...
raw:: [[source/coding-agent-components]]
---
...
- [[entity/coding-harness]] — 六大组件架构及 Harness 层次分类
- [[entity/harness]] — Agent 驾驭层（Coding harness 的上位概念）
- [[entity/agent-memory-system]] — 记忆系统对比（Hermes 四层 vs Raschka 双层）
- [[entity/skills]] — 可复用能力单元（Coding harness 工具体系的一部分）
- [[entity/progressive-disclosure]] — 按需加载工具（与组件 2/3 一致）
