...
- [[wip-limit]] — WIP 限制 + Overreach + Under-finish 核心概念
- [[feature-list-primitive]] — 范围表面和功能清单是承载任务边界的数据结构
- [[harness-5-subsystems]] — 任务边界控制是 harness 状态子系统的组成部分
