...
raw:: [[prevent-premature-completion]]
---
...
- [[completion-validation]] — 完成校验 + 验证-确认双闸门核心概念
- [[harness-observability]] — evaluator 是可观测性的实现载体
- [[feature-list-primitive]] — 终止标准的定义依赖功能清单三元组
