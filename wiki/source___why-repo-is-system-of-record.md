...
raw:: [[entity/repo-as-system-of-record]]
---
...
- [[entity/repo-as-system-of-record]] — 仓库即规范核心概念
- [[entity/harness-5-subsystems]] — 五子系统（状态子系统与此密切相关）
- [[entity/session-continuity]] — 跨会话连续性（依赖仓库作为事实来源）
